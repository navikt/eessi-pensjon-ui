...
declare module 'eessi-pensjon-ui' {
  ...
  import Image from 'forhandsvisningsfil/Image'
  import Other from 'forhandsvisningsfil/Other'
  import PDF from 'forhandsvisningsfil/Pdf'
  import File from 'forhandsvisningsfil/File'
