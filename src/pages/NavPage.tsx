    ...
    <Container>
      <Panel className='p-4'>
        ...
        <ul className='mt-4 mb-4'>
          <li><strong>A: </strong>AlertStripe, AlertStripeAdvarsel, AlertStripeFeil, AlertStripeInfo, AlertStripeSuksess
          </li>
          ...
          <li><strong>E: </strong>Ekspanderbartpanel, EkspanderbartpanelBase, Element, EtikettBase, EtikettAdvarsel,
            EtikettFokus, EtikettInfo, EtikettSuksess, EtikettLiten
          </li>
          ...
          <li><strong>P: </strong>Panel, Popover</li>
