...
const FileUploadPage: React.FC<PageProps> = ({ highContrast }: PageProps): JSX.Element => (
  <Container>
    <Panel className='p-4'>
      <Systemtittel className='mt-4 mb-4'>File Upload</Systemtittel>
      <Normaltekst className='mt-4 mb-4'>File upload component with drag and drop capability, compatible with mobile devices.</Normaltekst>
      <Undertittel className='pt-4 mb-4'>File Upload with initial file list</Undertittel>
      <Normaltekst className='mt-4 mb-4'>Either drag and drop more files into the drop area, or click on the drop area to open the file selection dialog.</Normaltekst>
      ...
      <table className='tabell'>
        ...
        <tbody>
          <tr>
            ...
            <td>false</td>
            <td>String with accepted mimetype or list of accepted mimetypes. If not defined, all files are accepted.</td>
            <td>-</td>
          </tr>
          <tr>
            <td>afterFileDrop</td>
