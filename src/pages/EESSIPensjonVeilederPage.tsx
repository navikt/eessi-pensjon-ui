...
const EESSIPensjonVeilederPage: React.FC<PageProps> = (): JSX.Element => {
  ...
  return (
    <Container>
      <Panel className='p-4'>
        ...
        <Normaltekst>This component renders the EESSI Pensjon veileder's avatar, named
        ...
        <Normaltekst className='pb-4'>Default component's
          classname: <code>c-EESSIPensjonVeileder</code>, <code>c-EESSIPensjonVeilederPanel</code>
        </Normaltekst>
...
export default EESSIPensjonVeilederPage
